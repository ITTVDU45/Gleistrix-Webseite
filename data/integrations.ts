...
export type Integration = {
  ...
  height?: number;
  /**
   * Logodatei ohne Weißraum am Rand – das Motiv sitzt bündig auf der Kante.
   * Solche Logos werden eine Stufe kleiner gesetzt, damit sie neben den
   * gepolsterten Logos nicht an den Rand zu stoßen scheinen.
   */
  tight?: boolean;
};
...
export const INTEGRATIONS: Integration[] = [
  ...
  { id: "deutsche-bahn", label: "Deutsche Bahn", src: "/logos/deutsche-bahn.png", width: 738, height: 210, tight: true },
  ...
  { id: "agenda", label: "Agenda", src: "/logos/agenda.jpeg", width: 640, height: 184, tight: true },
  { id: "stripe", label: "Stripe", src: "/logos/stripe.png", width: 500, height: 209 },
  { id: "paypal", label: "PayPal", src: "/logos/paypal.png", width: 738, height: 210, tight: true },
