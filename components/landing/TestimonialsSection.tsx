          ...
          >
            {TILES.map((tile, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`relative overflow-hidden rounded-2xl bg-slate-100 shadow-soft-sm ring-1 ring-slate-900/5 transition-transform duration-300 hover:z-10 hover:scale-105 ${shouldReduceMotion ? "" : floatClasses[index % floatClasses.length]}`}
