  ...
  return (
    <div className="overflow-hidden rounded-[1.6rem] border border-slate-200/80 bg-white shadow-[0_36px_90px_-38px_rgba(15,23,42,0.45)]">
      <div className="flex items-center justify-between gap-4 border-b border-slate-200/70 px-7 py-4">
        <span className="text-[0.68rem] font-bold uppercase tracking-[0.2em] text-brand-600">
          {catalog.plural}
        </span>
      ...
      <Link
        ...
        onClick={onNavigate}
        className="group flex items-center justify-between gap-4 border-t border-slate-200/70 bg-slate-50/70 px-7 py-4 text-sm font-semibold text-slate-900 transition-colors hover:bg-slate-100/80 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-500/20"
      >
...
function MegaMenuItem({
  ...
  return (
    <Link
      ...
      onClick={onNavigate}
      className="group flex items-start gap-3 rounded-2xl px-3 py-2.5 transition-colors hover:bg-slate-100/80 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-brand-500/20"
    >
      <span className="mt-0.5 flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-200/80 bg-white text-brand-600 transition-colors group-hover:border-brand-200 group-hover:bg-brand-50">
        {entry.logo ? (
          <Image
            src={entry.logo.src}
            alt=""
